 ...
 */
  ...
  toVideoPage: function (e) {
    ...
    wx.setStorageSync('TEMP-VIDEO-URL', url);
    wx.navigateTo({
      url: '../video/video',
    })
  },
  ...
  listStoreVideo: function () {
    weixinService.http(configUrl.service_api_server + '/store-videos/extra')
      .then(res => {
        console.log('[获取视频List]', res)
        this.setData({
          videos: res.list,
        })
      })
