...
Page({
  ...
  */
  ...
  onReady: function () {
    ...
    weixinService.http(configUrl.statistic_api_server + "/echarts/coupons/figures?firm_id=" + this.data.firmId)
      .then(res => {
        console.log('[现金券统计图表最后结果]', res)
        let chartData = {
