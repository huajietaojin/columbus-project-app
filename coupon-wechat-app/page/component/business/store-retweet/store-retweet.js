...
Page({
   ...
   */
  onReady: function () {
    weixinService.syncBrowseRecord({ path: '/business/storeRetweets', type: 1 })
  },
   ...
   */
  onUnload: function () {
    weixinService.syncBrowseRecord({ path: '/business/storeRetweets', type: 2 })
  },
